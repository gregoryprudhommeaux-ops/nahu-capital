...
export function ContactPanel({ dict }: Props) {
  ...
  return (
    <div className="contact-panel bg-navy text-cream">
      ...
      />
      <div className="wrap flex flex-col items-start py-8 md:py-9 lg:h-full lg:justify-center lg:w-auto lg:max-w-none lg:pr-10 lg:pl-[max(2.5rem,calc((100vw-1220px)/2))]">
        ...
        <label htmlFor={toggleId} className="contact-open w-fit max-w-fit shrink-0">
          {dict.open}
        </label>
      </div>
