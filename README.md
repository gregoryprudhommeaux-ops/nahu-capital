...
Sujets : hôtellerie, quartiers (dont une vue d’ensemble de Guadalajara), data centers, grands axes urbains (Reforma, La Défense). Le bandeau Contact montre l’Ángel de la Independencia sur Reforma. Sources : Pexels ; Wikimedia Commons (skyline Guadalajara, CC BY-SA 4.0 Isacdaavid ; La Défense, CC BY 4.0 Gugalcrom123 ; campus data center, CC BY-SA 4.0 Choinowski).
